  ...
  async.series(
    [ function(callback) {
        path.exists('./bundles', function(exists) {
          callback(!exists && new Error('Can\'t find bundle path. Are you sure this is ctrl?'));
        });
      }
    , function(callback) {
    ...
    , function(callback) {
        path.exists(bundlePath + '/bundle.js', function(exists) {
          callback(!exists && new Error('Can\'t find a bundle.js. Repo not a valid ctrl bundle'));
        });
      }
    , function(callback) {
